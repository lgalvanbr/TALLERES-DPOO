...
public class SandboxArreglos
{
    ...
    {
        arregloEnteros = Arrays.stream(arregloEnteros).filter(e -> e != valor).toArray();
    }
    ...
    {
        arregloCadenas = Arrays.stream(arregloCadenas).filter(c -> !c.equals(cadena)).toArray(String[]::new);
    }
    ...
    {
        return (int) Arrays.stream(arregloEnteros).filter(e -> e == valor).count();
    }
    ...
    {
    	int[] indices = new int[arregloEnteros.length];
        int count = 0;
