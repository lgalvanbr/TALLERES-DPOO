...
public class ProductoAjustado implements Producto
{
    ...
    public int getPrecio() {
        int precioAjustado = productoBase.getPrecio(); // Obtiene el precio del producto base

        // Sumar el costo de los ingredientes adicionales
        

        return precioAjustado; // Retorna el precio total ajustado
    }
